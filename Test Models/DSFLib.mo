      ...
      package Interfaces
        ...
        model FlangeToReal
          ...
          Modelica.Blocks.Interfaces.RealOutput y annotation(
            Placement(transformation(origin = {106, -2}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {102, -2}, extent = {{-10, -10}, {10, 10}})));
        equation
        ...
        annotation(
            Icon(graphics = {Line(origin = {6.20631, 0.0141406}, points = {{-86.2063, -0.0141406}, {85.7937, -0.0141406}, {61.7937, 19.9859}, {85.7937, -0.0141406}, {63.7937, -20.0141}, {85.7937, -0.0141406}})}));
        end FlangeToReal;
        
        model FlangeToRealForce
          input Flange flange annotation(
            Placement(transformation(origin = {-96, -2}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-96, -2}, extent = {{-10, -10}, {10, 10}})));
          Modelica.Blocks.Interfaces.RealOutput y annotation(
            Placement(transformation(origin = {106, -2}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {102, -2}, extent = {{-10, -10}, {10, 10}})));
        equation
        ...
        annotation(
            Icon(graphics = {Line(origin = {6.20631, 0.0141406}, points = {{-86.2063, -0.0141406}, {85.7937, -0.0141406}, {61.7937, 19.9859}, {85.7937, -0.0141406}, {63.7937, -20.0141}, {85.7937, -0.0141406}})}));
        end FlangeToRealForce;

        model RealToPosition
          parameter Real mult = 0.001;
          Flange flange annotation(
            Placement(transformation(origin = {-96, -2}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {102, 0}, extent = {{-10, -10}, {10, 10}})));
          Modelica.Blocks.Interfaces.RealInput y annotation(
            Placement(transformation(origin = {-96, 0}, extent = {{-20, -20}, {20, 20}}), iconTransformation(origin = {-92, 0}, extent = {{-16, -16}, {16, 16}})));
        equation
